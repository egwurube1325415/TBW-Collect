...
import IMG_0113 from "../assets/img/IMG_0113.png";
      ...
      <section class="content">
        {showCartList ? (
          ...
          <>
            <h1>How to order?</h1>
            <p>
              Thank you for chosing Bodywears collections by Shawn
              <br />
              Now, you can select your items by category below.
            </p>
            <ul class="category">
              <li class="active">
                <a href="/">All</a>
